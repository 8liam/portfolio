...
export default function Journey() {
  ...
  return (
    <section className="border-[#1C1C21] border-b" id="journey">
      <h2 className="p-4 text-3xl font-bold font-pixel-circle border-b uppercase">
            ...
            <div>
              <div className="grid grid-cols-12">
                <div className="lg:col-span-4 col-span-12 p-4 border-[#1C1C21] border-b lg:border-r">
                  <ScrambleText
                    as="h4"
                    className="font-pixel-circle font-semibold text-2xl"
                ...
                <div className="lg:col-span-4 col-span-12 p-4 border-[#1C1C21] border-b lg:border-r ">
                  <ScrambleText
                    as="h5"
                    className="font-pixel-circle font-semibold text-2xl uppercase lg:text-center"
                ...
                <div className="lg:col-span-4 col-span-12 p-4 border-[#1C1C21] border-b ">
                  <ScrambleText
                    as="p"
                    className="font-pixel-circle font-semibold text-2xl lg:text-right uppercase"
                    ...
                    <div className="flex-1 p-4">
                      <div className="space-y-1 px-4 ">
                        {currentExperience.points.map((point, index) => (
                          <p
                            key={index}
                            className={`before:content-['-'] before:inline-block before:w-[1em] before:-ml-[1em] before:text-gray-500 before:mr-1`}
                          >
                            {point}
                          </p>
                        ))}
