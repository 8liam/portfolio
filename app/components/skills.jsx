    ...
    <section className="border-t border-[#1C1C21]" id="about">
      <div className="grid grid-cols-1 lg:grid-cols-3 lg:grid-rows-2 ">
        ...
        <div className=" bg-white  border-[#1C1C21]  p-4 lg:col-span-2 space-y-1">
          <Image
            src={"/knowledge-in-best-practices.png"}
            width={2000}
            height={500}
            alt="Australia Map"
            className="w-full object-contain select-none"
          />
          <h4 className="font-pixel-circle font-semibold text-lg">
            Knowledge in Best Practices
          </h4>
          <p className="font-sans">
            I follow industry best practices by writing clean, maintainable, and
            well-documented code. I use Git for version control and prioritize
            performance, accessibility, SEO, and security to deliver
